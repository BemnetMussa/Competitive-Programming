...
def solve():
    '''
    Given: an array a, n: int, k: int
    Where; let a[l, r] be a subarray* of a. 
    perform ths the followign to detemrine a[l,r] is awesome
        - initally. farmer has K empty multisets, numbered from 1 upto k
    '''
